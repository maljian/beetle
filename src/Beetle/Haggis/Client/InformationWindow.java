...
public class InformationWindow extends JFrame {
	...
	public InformationWindow() {
			...
			panel.add(lblIpadresse, gbc_lblIpadresse);
			...
			panel.add(lblGetip, gbc_lblGetip);
			...
			panel.add(lblGetnumberplayer, gbc_lblGetnumberplayer);
			...
			panel.add(lblGettargetpoint, gbc_lblGettargetpoint);
			...
			panel.add(lblSpieler_1, gbc_lblSpieler_1);
			...
			panel.add(lblSpieler, gbc_lblSpieler);
			...
			panel.add(lblGetpoints, gbc_lblGetpoints);
			...
			panel.add(lblSpieler_2, gbc_lblSpieler_2);
			...
			panel.add(lblSpieler_3, gbc_lblSpieler_3);
